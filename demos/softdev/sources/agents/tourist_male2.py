...
_STATE_NONE,  _STATE_IDLE, _STATE_STANDSTILL, _STATE_RUN, _STATE_FOLLOW, _STATE_RAND = 0, 1, 2, 3, 4, 5

class Tourist_male2(Agent):
    def __init__(self, settings, model, agentName, layer, uniqInMap=True):
        super(Tourist_male2, self).__init__(settings, model, agentName, layer, uniqInMap)
    ...
    def follow_hero(self):
        ...
        self.agent.follow('run', self.hero, 3*self.GIRL_SPEED)
    ...
    def standstill(self):
        self.state = _STATE_STANDSTILL
        self.agent.actRepeat('stand')
 
    def run(self, location):
        self.state = _STATE_RUN
        self.agent.move('walk', location, self.GIRL_SPEED)
