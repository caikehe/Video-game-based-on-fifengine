...
_STATE_NONE, _STATE_IDLE, _STATE_RUN, _STATE_FOLLOW, _STATE_STANDSTILL= 0, 1, 2, 3, 4
...
class Girl(Agent):
    ...
    def start(self):
        # this code is changed by CAI Kehe, 8/12/2013
        # self.follow_hero()
    ...
    def run(self, location):
        ...
        self.agent.move('run', location, 3*self.GIRL_SPEED)
