...
from sources.common.eventlistenerbase import EventListenerBase
from fife.extensions.savers import saveMapFile
from fife.extensions.soundmanager import SoundManager
from agents.hero import Hero
from agents.girl import Girl
from agents.tourist_male2 import Tourist_male2
from agents.bee import Bee
from agents.beekeeper import Beekeeper
from agents.hippie_priest import Hippie_priest
...
class World(EventListenerBase):
    ...
    def reset(self):
        ...
        self.cameras = {}
        self.hero, self.girl, self.bee, self.clouds, self.beekeepers,self.hippie_priest = None, None, None, [], [], []
    ...
    def initCameras(self):
        ...
        for cam in self.map.getCameras():
            ...
            cam.resetRenderers()
            # set two cameras to follow the girl and hero
            if self.glob_count%2==0:  
                self.cameras['main'].attach(self.hero.agent)
            elif self.glob_count%2==1:  
                self.cameras['main'].attach(self.girl.agent)
    ...
    # This code is changed by CAI Kehe, 9/12/2013
    def mousePressed(self, evt):
        ...
        if (evt.getButton() == fife.MouseEvent.LEFT):
            ...
            if self.glob_count % 2 == 0:
                ...
                self.girl.run( self.getLocationAt(clickpoint) )
    ...
    def lightSourceIntensity(self, value):
        if self.light_sources+value <= 255 and self.light_sources+value >= 0:
            ...
            renderer.removeAll("bee_simple_light")
    ...
    def onInspectButtonPress(self):
        ...
        if inst.getObject().getId()=='dynamites_lid_broken':
            saytext.append('IT IS DANGEROUS!!!' )
        else:
